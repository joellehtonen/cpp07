...
int main( void ) {
...

	{
		...
		std::cout << "before swap: a = " << RED << &a1 << RESET << ", b = " << GREEN << &b1 << RESET << std::endl;
		...
		std::cout << "\nSWAP\n\n";
		std::cout << "memory location of the pointers themselves\n";
		std::cout << "after swap: a = " << RED << &a1 << RESET << ", b = " << GREEN << &b1 << RESET << std::endl;
		std::cout << "memory they are pointing to\n";
		std::cout << "after swap: a = " << GREEN << a1 << RESET << ", b = " << RED << b1 << RESET << std::endl;
		std::cout << "content in that memory\n";
		std::cout << "after swap: a = " << GREEN << *a1 << RESET << ", b = " << RED << *b1 << RESET << std::endl;
		...
		*b2 = new double(-2.2);
		...
		std::cout << "before swap: a = " << BLUE << &a2 << RESET << ", b = " << CYAN << &b2 << RESET << std::endl;
		std::cout << "memory they are pointing to\n";
		std::cout << "before swap: a = " << BLUE << a2 << RESET << ", b = " << CYAN << b2 << RESET << std::endl;
		...
		std::cout << "after swap: a = " << BLUE << &a2 << RESET << ", b = " << CYAN << &b2 << RESET << std::endl;
		std::cout << "memory they are pointing to\n";
		std::cout << "after swap: a = " << CYAN << a2 << RESET << ", b = " << BLUE << b2 << RESET << std::endl;
		std::cout << "content in that memory (another pointer)\n";
		std::cout << "after swap: a = " << CYAN << *a2 << RESET << ", b = " << BLUE << *b2 << RESET << std::endl;
		std::cout << "content in that memory (value pointed to by the second pointer)\n";
		std::cout << "after swap: a = " << CYAN << **a2 << RESET << ", b = " << BLUE << **b2 << RESET << std::endl;
